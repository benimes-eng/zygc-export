...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ZYGC Global Trade — Ethiopia's Trusted Global Agricultural Export Partner" },
      { name: "description", content: "Premium Ethiopian livestock, oil seeds and pulses exported globally with quality, integrity and international standards." },
      { property: "og:title", content: "ZYGC Global Trade — Ethiopia's Trusted Global Agricultural Export Partner" },
      ...
      { name: "twitter:title", content: "ZYGC Global Trade — Ethiopia's Trusted Global Agricultural Export Partner" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=Inter:wght@400;500;600;700&display=swap" },
    ],
  }),
