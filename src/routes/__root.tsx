...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ZYGC Export PLC — Ethiopia's Trusted Global Agricultural Export Partner" },
      ...
      { property: "og:title", content: "ZYGC Export PLC — Ethiopia's Trusted Global Agricultural Export Partner" },
